  ...
  const projects = [
    {
      ...
      liveUrl: "https://productivity-manager-fe.vercel.app/login",
      githubUrl: "https://github.com/raju0076/productivity_manager_be"
    },
    {
  title: "SkillHub",
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                <img
                  src={project.image}
                  alt={`${project.title} project screenshot showing ${project.technologies.join(", ")}`}
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-3 py-1 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-300 rounded-full text-sm font-medium border border-cyan-500/30 transition-transform hover:scale-105"
                    >
                      {tech}
                    </span>
                  ))}
